...
class EditCarScreen extends StatefulWidget {
  ...
  const EditCarScreen({super.key, required this.carToEdit});
...
class _EditCarScreenState extends State<EditCarScreen> {
  ...
  final List<int> _allowedCylinders = [3, 4, 6, 8, 10, 12, 16];
  ...
  void initState() {
    ...
    _selectedBrandId = car.brandId;
    _selectedBrandName = car.brandName;
    _cylinders = car.cylinders;
    _transmission = car.transmission;
    _year = car.year;
    _category = car.category;
    _nameController.text = car.name;
    _engineController.text = car.engineCapacity;
    _hpController.text = car.horsepower.toString();
    _zeroHundredController.text = car.zeroToHundred.toString();
    _priceEGPController.text = car.priceEGP.toString();
    _priceUSDController.text = car.priceUSD.toString();
    for (int i = 0; i < car.imagePaths.length && i < 5; i++) {
      if (car.imagePaths[i].isNotEmpty) {
        _images[i] = car.imagePaths[i];
      }
    }
  }
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        try {
          ...
          debugPrint('Error saving image to app dir: $e');
  ...
  void _updateCar(AppState appState, String lang) async {
    if (_isSaving) return;
    ...
    try {
      final updatedCar = Car(
        ...
        createdAt: widget.carToEdit.createdAt,
      );

      await appState.updateCar(updatedCar);
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.get('car_updated', lang))),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${AppLocalizations.get('error_updating_car', lang)}: $e',
          ),
          backgroundColor: Colors.red,
        ),
      );
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // ✅ على الديسكتوب: 0-100 + EGP + USD في صف
                          if (isWide)
                            Row(
                              children: [
                                Expanded(
                          ...
                          SizedBox(
                            ...
                            child: MouseRegion(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () => _updateCar(appState, lang),
                                child: _isSaving
                                    ? const SizedBox(
                                        height: 24,
                                        width: 24,
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              AppLocalizations.get('edit_car', lang),
